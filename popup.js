document.addEventListener('DOMContentLoaded', () => {
  ...
  errorMessage.id = 'errorMessage'; // Set an ID for the error message
  errorMessage.classList.add('hidden'); // Initially hide the error message
  document.body.appendChild(errorMessage); // Append it to the body (or any container)
  ...
  function saveTabs() {
      ...
      if (!groupName) {
          errorMessage.innerText = 'Please fill out the group name first!'; // Set error message
